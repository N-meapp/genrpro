...
def dashboard(request):
    if "name" in request.session:
        ...
        show_news = News.objects.order_by('-created_at'),


        context={
                'offerdata': Offer.objects.order_by('-created_at'),
                'enquirydata': Enquiry.objects.order_by('-created_at'),
                'careerdata': Career.objects.order_by('-created_at'),
                'gallery_images': Gallery.objects.order_by('-created_at'),
